  ...
  return (
    <View className="flex-1 bg-light-100 dark:bg-dark-300">
      ...
      <Animated.ScrollView
        ...
        // contentContainerStyle={{ marginTop: insets.top + 60 }}
      >
        <Wrapper>
          <View
          ...
          >
            ...
            <Pressable className="mt-1.5">
              <Text className="dark:text-white font-poppins_regular tracking-tight font-bold text-lg">
                +254 789 765 432
              </Text>
            </Pressable>
          </View>
          ...
          <View className="flex-row flex-1 gap-x-6 items-center mb-6 justify-center">
            <TouchableOpacity className="bg-light-100 h-20 w-28 items-center dark:bg-dark-100 p-4 rounded-md">
              <ThemeIcon icon={MessageSquareText} />
        ...
        {/* common groups */}
        <Wrapper className="mt-2" headerTitle="Common group">
          <TouchableOpacity
            className="flex-row flex-1 items-center gap-x-4"
            activeOpacity={0.7}
          >
            <View className="size-12 items-center justify-center rounded-full bg-primary">
              <ThemeIcon icon={Users} darkColor="#fff" lightColor="#fff" />
            </View>
